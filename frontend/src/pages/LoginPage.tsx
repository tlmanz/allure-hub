    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background relative">
        ...
        <div className="relative z-10 flex flex-col items-center gap-8 px-12">
          <div className="flex items-center gap-4 animate-fade-in-up">
            ...
            <h1 className="text-4xl font-black tracking-tighter font-headline leading-none">
              <span className="text-gray-900 dark:text-white">Allure</span><br />
          ...
          <span className="text-xs font-mono text-on-surface-variant/50 tracking-wider animate-fade-in" style={{ animationDelay: '0.3s' }}>
            {APP_VERSION}
          </span>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm flex flex-col items-center gap-8">
          ...
          <p className="text-[11px] text-on-surface-variant/50 font-label text-center leading-relaxed max-w-xs animate-fade-in" style={{ animationDelay: '0.4s' }}>
